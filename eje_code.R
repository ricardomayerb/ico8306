...
#' 
#' 
#' Donde $z_{\alpha/2}$  es igual a -1,645 o -1,96 o -2,576 para $\alpha $ gual a 10, 5 y 1 por ciento, respectivamente 
#' 
#' 
...
#' desviaciòn estàndar muestral es 251,789 U.F. (doscientos cincuenta y uno coma setecientos ochenta y nueve U.F.)
...
#' 3. *Tamaño de la muestra para una estimación de la proporción poblacional*
