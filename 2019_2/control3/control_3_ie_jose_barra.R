...
sd(e)
# 5
quantile(e, c(0.25,0.75))
# 6
filter(nombres60, examen>=4)%>%
             select(c("apellido","examen"))
#7 Esta es la proporcón de estudiantes con una nota mayor o igual a 4 en exámen, donde 40 son los con nota mayor o igual a 4 y un total de 60 estrudiantes.
40/60
# 8
poblacion <- rexp(10000, rate = 25)
