...
# queremos calcular el cuantil 37 escribiremos en R quantile(x, 0.3

v1<-c(misdatos$velocidad_viento)
median(v1)
...
v2<-c(misdatos$temperatura)
v3<-c(misdatos$humedad)
v4<-c(misdatos$punto_rocio)
v1<-c(misdatos$velocidad_viento)
hist(v2)
hist(v3)
hist(v4)
