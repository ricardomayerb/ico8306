...
# misdatos <- read_excel("datos_ie.xlsw")

datos_ie <- misdatos
summary(datos_ie)


# install.packages("datos_ie.xlsw")
...
quantile(datos_ie$velocidad_viento,0.25)
...
# 3.3 la cantidad de observaciones (n)   (2 ptos)
robs<-datos_ie$temperatura
# 3.4 la desviación estandar, dividida por la raíz de n  (2 pto)
sd(datos_ie$temperatura)/2612^1/2
