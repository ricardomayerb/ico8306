...
hist(misdatos$temperatura,main="Histograma Temperatura")
hist(misdatos$humedad,main="Histograma Humedad")
hist(misdatos$punto_rocio,main="Histograma Rocio")
hist(misdatos$velocidad_viento,main="Histograma Velocidad Viento")
