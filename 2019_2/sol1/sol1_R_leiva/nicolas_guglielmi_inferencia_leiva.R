...
#nicolas_guglielmi_inferencia_leiva.R
...
quantile(velocidad_viento, probs = 0.025)
# 2.2 la mediana (2 pto)
median(velocidad_viento)

# 2.3 el cuantil 0.975 (2 pto)
quantile(velocidad_viento, probs = 0.975)
...
L <- pnorm(1.2, lower.tail = TRUE)
R <- pnorm(-1, lower.tail = TRUE)
