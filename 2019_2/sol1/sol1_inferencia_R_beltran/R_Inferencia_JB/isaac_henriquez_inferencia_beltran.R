...
#el cuantil 0.025 da como valor 0

# 2.2 la mediana (2 pto)
#respuesta:
median(velocidad_viento)
#la mediana es 9.20624
...
#respuesta:
mean(temperatura)
#la media de la variable temperatura es 55.45093

# 3.2 la desviación estandar    (2 pto)
sd(temperatura)
#la desviacion estandar de la temperatura es 17.88357
# 3.3 la cantidad de observaciones (n)   (2 pto)
length(temperatura)
#la cantidad de datos que hay en la variable temperatura son 2612
# 3.4 la desviación estandar, dividida por la raíz de n  (2 pto)
sd(temperatura)/sqrt(length(temperatura))
#el resultado de esta operacion es 0.3499192
...
hist(humedad)
#histograma de punto_rocio
hist(punto_rocio)
#histograma de velocidad_viento
...
#respuesta:
# la P(-1<= < <= 1.2) se puede escribir o calcular asi:
pnorm(1.2)-pnorm(-1)
#el valor que da de esta ecuacion es 0.7262751
