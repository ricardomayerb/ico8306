...
# 2.1 el cuantil 0.025 (2 pto) #quantile(misdatos$velocidad_viento, 0.025)
# 2.2 la mediana (2 pto)        #median(misdatos$velocidad_viento)
# 2.3 el cuantil 0.975 (2 pto)  # quantile(misdatos$velocidad_viento, 0.975)
...
# 3.1 la media (2 pto)     #mean(misdatos$temperatura)
# 3.2 la desviación estandar   #sd(misdatos$temperatura) (2 pto)
