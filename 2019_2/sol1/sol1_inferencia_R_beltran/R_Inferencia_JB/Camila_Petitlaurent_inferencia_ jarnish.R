...
#en la parte donde estan las varibles y sus decripciones dice
# n =2612
...
# x es velocidadn del viento 
#y es temperatra
z<- misdatos$humedad
a<- misdatos$punto_rocio

hist (y, main= "temperatura")
hist (z, main= "humendad")
hist (a, main="punto de rocio")
hist (x, main= "velocidad del viento")


# 5. Use el comando pnorm, para encontrar la probabilidad de que una
# variable aleatoria normal estándard esté entre 
# -1 y 1.2, es decir, encontrar P(-1 <= z <= 1.2)
# Nota, el comando pnorm asume por defecto que nuestra normal
# es estándar. (2 pto)
