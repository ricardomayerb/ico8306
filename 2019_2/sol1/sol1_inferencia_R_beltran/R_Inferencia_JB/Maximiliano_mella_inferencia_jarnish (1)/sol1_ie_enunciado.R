...
y <- c(misdatos$velocidad_viento)

quantile(y,0.025) #2.5% el cuantil 0.025 es de 2.5%
median(y,)         #9.20624 la mediana es de 9.20624
quantile(y,0.975) #23.0156 el cuantil 0.975 es de 23.0156
...
y <- c(misdatos$temperatura)
mean(y)         #55.45093 La media es de 55.45
sd(y)            #17.88357 la desviacion estandar es de 17.88
length(y)        #2612    la cantidad e observacines es de 2612
z <- c(sd(y))
sqrt(z)       #4.228898 la desviacon estandar dividida por la raiz de n es de 4.22
...
a <- c(misdatos$temperatura)
hist(a)

b <- c(misdatos$humedad)
hist(b)

c <- c(misdatos$punto_rocio)
hist(c)

d <- c(misdatos$velocidad_viento)
hist(d)
...
pnorm(1.2)-pnorm(-1) #0.7262751 La probabilidad es de 72.62%
