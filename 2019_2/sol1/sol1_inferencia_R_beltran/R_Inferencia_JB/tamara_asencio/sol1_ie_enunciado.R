...
misdatosread_excel("datos_ie.xlsx")
...
#El cuartil 0.025 de la variable velocidad viento es cero
...
#El cuartil 0.975 de la variable velocidad tiempo es 23.0156
