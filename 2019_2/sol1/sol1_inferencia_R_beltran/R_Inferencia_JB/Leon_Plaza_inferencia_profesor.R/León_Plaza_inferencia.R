...
quantile(datos_ie$velocidad_viento,0.025)
#el cuantil 0.025 es 0
median(datos_ie$velocidad_viento)
#la mediana es 9.206
quantile(datos_ie$velocidad_viento,0.975)
#el cuantil 0.975 es 23.0156
...
mean(datos_ie$temperatura)
#La media es 55.45
sd(datos_ie$temperatura)
#la desviación estandar es 17.88
length(datos_ie$temperatura)
sqrt(2)
(sd(datos_ie$temperatura))/sqrt(2)
...
hist(datos_ie$temperatura,col="red",xlab="temperatura",ylab ="frecuencia",main = "Temperatura")
hist(datos_ie$humedad,col="blue",xlab="humedad",ylab ="frecuencia",main="Humedad")
hist(datos_ie$punto_rocio,col="green",xlab="puntos de rocio",ylab ="frecuencia",main="puntos rocio")
hist(datos_ie$velocidad_viento,col="light blue",xlab="velocidad del viento",ylab ="frecuencia",main = "Velocidad del viento")
