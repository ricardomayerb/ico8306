...
hist(temperatura,    #datos
     col = rainbow(12),    #color
     xlab = "temperatura", #nombre del eje x
     ylab = "Frecuencias", #nombre del eje y
     main = "Temperatura")

humedad <- misdatos$humedad
hist(humedad,    #datos
     col = rainbow(12),    #color
     xlab = "humedad", #nombre del eje x
     ylab = "Frecuencias", #nombre del eje y
     main = "Humedad")

punto_rocio <- misdatos$punto_rocio
hist(punto_rocio,    #datos
     col = rainbow(12),    #color
     xlab = "punto_rocio", #nombre del eje x
     ylab = "Frecuencias", #nombre del eje y
     main = "Punto Rocio")

hist(velocidad_viento,    #datos
     col = rainbow(12),    #color
     xlab = "velocidad_viento", #nombre del eje x
     ylab = "Frecuencias", #nombre del eje y
     main = "Velocidad viento")
