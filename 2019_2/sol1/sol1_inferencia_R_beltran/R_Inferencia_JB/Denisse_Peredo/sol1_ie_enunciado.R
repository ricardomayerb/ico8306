...
mean(datos_ie$velocidad_viento)
...
hist(x = datos_ie$temperatura, main = "Histograma de Temperatura", xlab = "Temperatura", ylab = "Frecuencia")

hist(x = datos_ie$humedad, main = "Histograma de Humedad", xlab = "Humedad", ylab = "Frecuencia")

hist(x = datos_ie$punto_rocio, main = "Histograma de Punto Rocio", xlab = "Punto_rocio", ylab = "Frecuencia")

hist(x = datos_ie$velocidad_viento, main = "Histograma de Velocidad Viento", xlab = "velocidad_viento", ylab = "Frecuencia")
