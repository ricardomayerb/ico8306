...
# 2.1 el cuantil 0.025 (2 pto) #2.5% entonces 0
quantile(misdatos$velocidad_viento, 0.025)
# 2.2 la mediana (2 pto) #50% entonces 9.20624
# 2.3 el cuantil 0.975 (2 pto) #97.5% entonces 23.0156
...
# 3.1 la media (2 pto) #55.40
mean(misdatos$temperatura)
# 3.2 la desviación estandar    (2 pto) #17.88357
sd(misdatos$temperatura)
# 3.3 la cantidad de observaciones (n)   (2 pto) #2612
length(misdatos$temperatura)
# 3.4 la desviación estandar, dividida por la raíz de n  (2 pto) #0.006846698
sd(misdatos$temperatura)/length(misdatos$temperatura)
...
pnorm(1.2, lower.tail = FALSE )-pnorm(-1, lower.tail = FALSE )
#-0.7262751
