...
#R2.1:quantile(misdatos$velocidad_viento, 0.25)
#R2.2:median(misdatos$velocidad_viento) o quantile(misdatos$velocidad_viento,0.5)
#R2.3: quantile(misdatos$velocidad_viento,0.975)
...
#R3.1:mean(misdatos$temperatura)
#R3.2:sd(misdatos$temperatura)
#R3.3:length(misdatos)
#R3.4:sd(misdatos$temperatura)/sqrt(length(misdatos))
...
#R.temperatura:hist(misdatos$temperatura)
#R.humedad:hist(misdatos$humedad)
#R.punto.rocio: hist(misdatos$punto_rocio)
#R.velocidad_viento:hist(misdatos$velocidad_viento)
