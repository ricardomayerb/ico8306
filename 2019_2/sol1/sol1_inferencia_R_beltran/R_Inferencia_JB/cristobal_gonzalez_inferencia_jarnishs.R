...
quantile(misdatos$velocidad_viento, 0.5)
...
sd(misdatos$temperatura)/sqrt(length(misdatos$temperatura))
...
hist(misdatos$temperatura, main = "Temperatura", xlab = "Grados", ylab = "Frecuencia")
hist(misdatos$humedad, main = "Humedad", xlab = "Cantidad de Humedad", ylab = "Frecuencia")
hist(misdatos$ punto_rocio, main = "Grafica del Punto de Rocio", xlab = "Punto de Rocio", ylab = "Frecuencia")
hist(misdatos$velocidad_viento, main = "Grafico de Velocidad del Viento", xlab = "Velocidad", ylab = "Frecuencia")
