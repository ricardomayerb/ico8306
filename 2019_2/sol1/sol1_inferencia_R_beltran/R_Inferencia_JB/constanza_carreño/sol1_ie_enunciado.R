...
hist(misdatos$temperatura, col = "yellow")

hist(misdatos$humedad, col = "orange")
...
# Nota, el comando pnorm asume por defecto que nuestra normal es estándar. (2 p
