...
# 2.1 el cuantil 0.025 (2 pto) quantile(misdatos$velocidad_viento, 0.0025) R=0
# 2.2 la mediana (2 pto) mean(misdatos$velocidad_viento) R=10.49095
# 2.3 el cuantil 0.975 (2 pto) quantile(misdatos$velocidad_viento, 0.975) R=23.0156
...
# 3.1 la media (2 pto) mean(misdatos$temperatura) R=55.45093
# 3.2 la desviación estandar    (2 pto) sd(misdatos$temperatura) R=17.88357
# 3.3 la cantidad de observaciones (n)   (2 pto)  length(misdatos$temperatura) R=2612
# 3.4 la desviación estandar, dividida por la raíz de n sd(misdatos$temperatura)/sqrt(2612) R=0.3499191 (2 pto) 
...
# estándard esté entre -1 y 1.2, es decir, encontrar P(-1 <= z <= 1.2) pnorm(1.2)-pnorm(-1) R=0.726275
