...
hist(misdatos$temperatura, main = "Histograma Temperatura", col= rainbow(10))
hist(misdatos$humedad, main= "Histograma Humedad", col=rainbow(10))
hist(misdatos$punto_rocio, main="Histograma Punto de Rocio", col=rainbow(10))
hist(misdatos$velocidad_viento, main="Histograma Velocidad del Viento", col= rainbow(10))
