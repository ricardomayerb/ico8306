...
m <- mean(misdatos$temperatura)
s <- sd(misdatos$temperatura)
l <- length(misdatos$temperatura)
s/(l**(1/2))
...
hist(c(misdatos$temperatura,misdatos$punto_rocio,misdatos$humedad,misdatos$velocidad_viento))
