...
#instalé previamente el paquete
library(tidyverse)

pnorm(1.2) 
pnorm(-1)

#por alguna razon no me dejaba restarlos sin asiganrles un "value",
#me decia que no existía la funcion
