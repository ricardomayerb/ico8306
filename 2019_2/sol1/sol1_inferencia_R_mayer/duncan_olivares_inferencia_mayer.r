...
quantile(misdatos$velocidad_viento, c(0.025,0.50,0.975)) #todos los valores 

quantile(misdatos$velocidad_viento, 0.025) #cuantil velocidad viento 0.025
median(misdatos$velocidad_viento, 0.5) #mediana velocidad viento
quantile(misdatos$velocidad_viento, 0.975) #cuantil velovidad viento 0.975
...
hist(misdatos$temperatura, col = "blue") #histograma temperatura
hist(misdatos$humedad, col = "red") #histograma humedad
hist(misdatos$punto_rocio, col = "blue") #histograma punto rocio
hist(misdatos$velocidad_viento, col= "red") #histograma velocidad viento
