...
nrow(misdatos)
n<-nrow(misdatos)
sd_temp <- sd(misdatos$temperatura)
nsqrt<- sqrt(n)
sd_temp/nsqrt
...
hist(misdatos$temperatura, col= blues9)
hist(misdatos$humedad, col= blues9)
hist(misdatos$punto_rocio, col= blues9)
hist(misdatos$velocidad_viento, col=blues9)
...
pnorm(-1<=1.2, mean = 0, sd = 1, log = FALSE)
