...
quantile(misdatos$velocidad_viento,probs = c(0.025))
# 2.2 la mediana (2 pto)
median(misdatos$velocidad_viento)
# 2.3 el cuantil 0.975 (2 pto)
quantile(misdatos$velocidad_viento,probs = c(0.975))
...
# Nota, el comando pnorm asume por defecto que nuestra normal es estándar. (2 pts)
pnorm(c(1.2), mean = 0, sd = 1) - pnorm(c(-2), mean = 0, sd = 1)
