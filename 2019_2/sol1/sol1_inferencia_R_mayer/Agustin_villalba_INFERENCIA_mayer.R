...
quantile(misdatos$velocidad_viento, c(0.025, 0.5, 0.975))
...
quantile(misdatos$temperatura, 0.5)
resultado_1 <- misdatos$temperatura
tamaño_temperatura <- length(reresultado_1)
...
hist(misdatos$humedad, col = "black")
hist(misdatos$punto_rocio, col = "orange")
...
probabilidad_menos1 <-  pnorm(-1, mean=0, sd=1)
probabilida_1.2 <- pnorm(1.2, mean = 0, sd = 1)

resultado = probabilida_1.2 - probabilidad_menos1
