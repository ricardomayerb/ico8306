...
misdatos$velocidad_viento
velocidad <- misdatos$velocidad_viento
#2.1
quantile(velocidad, 0.025)
#2.2
quantile(velocidad, 0.5)
#2.3
quantile(velocidad, 0.975)
...
misdatos$temperatura
temperatura1 <- misdatos$temperatura   
#3.1
mean(temperatura1)
#3.2
sd(temperatura1)
